...
@NamedQueries({
    ...
    @NamedQuery(name = "Questions.findBySequence", query = "SELECT q FROM Questions q WHERE q.sequence = :sequence"),
...
public class Questions implements Serializable {
    ...
    public Questions(Long id, Date createdAt, Date updatedAt) {
        this.id = id;
    ...
    public String toString() {
        return "com.matheusflausino.models.Questions[ id=" + id + " ]";
    }
